class ParagraphContentLoader {
  constructor() {
    ...
    this.contentDirectories = {
      ...
      'itp-gallery': 'content/itp-gallery/',
      'nachsterb-inn': 'content/nachsterb-inn/',
      'critical-clockwerkshop': 'content/critical-clockwerkshop/'
    };
  ...
  async fetchContent(page, hookPath) {
    ...
    const baseDir = this.contentDirectories[page];
    if (!baseDir) {
      throw new Error(`Unknown page: ${page}`);
    }

    const filePath = `${baseDir}${hookPath}.txt`;
